...
export default function Contact() {
  ...
  return (
    <footer id="contact" className="py-24 bg-slate-950 text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center relative z-10">
        ...
        >
          <div className="w-20 h-20 bg-slate-900 border border-slate-800 rounded-3xl mx-auto flex items-center justify-center mb-8 shadow-inner shadow-black/50 cursor-default">
          ...
          >
            <motion.a 
              ...
              className="p-5 rounded-2xl bg-slate-900 border border-slate-800 hover:bg-slate-800 hover:border-slate-700 hover:text-indigo-400 transition-all group hover:-translate-y-1 shadow-lg"
              aria-label="Email"
            >
